...
{
    public class FixedFluentValidationObjectModelValidator : IObjectModelValidator
    {
        ...
        /// </summary>
        public FixedFluentValidationObjectModelValidator(IModelMetadataProvider modelMetadataProvider, IList<IModelValidatorProvider> validatorProviders, IValidatorFactory validatorFactory)
        {
        ...
        public void Validate(ActionContext actionContext, ValidationStateDictionary validationState, string prefix, object model)
        {
            ...
            if (model != null)
            {
                validator = this._validatorFactory.GetValidator(metadata.ModelType);
